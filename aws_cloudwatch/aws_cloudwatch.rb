...
module CloudWatch
  ...
  class Response
    ...
    def parse_error
      ...
      [["PluginError: cannot parse the error response for the document"]]
    end
  ...
  class AWSAuthConnection
    ...
    def make_request(action, params, data='')
      ...
      @http.start do
        ...
        puts "params:", p(params) if @verbose
        ...
        puts "request address : #{@http.use_ssl? ? 'https':'http'}://#{@http.address}:#{@http.port}/#{path}" if @verbose
